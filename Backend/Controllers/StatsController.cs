...
/// <summary>
/// Controlador de estad�sticas y reportes
...
public class StatsController : ControllerBase
{
    ...
    public async Task<IActionResult> GetDailyTrend([FromQuery] int days = 30)
    {
        try
        {
            ...
            // Usar el m�todo optimizado que hace GROUP BY en SQL
    ...
    public async Task<IActionResult> GetStatsByDepartment([FromQuery] DateTime? date_from = null, [FromQuery] DateTime? date_to = null)
    {
        ...
        catch (Exception ex)
        {
            ...
            return StatusCode(500, new { error = "Error al obtener estad�sticas por departamento" });
        }
    }

    /// <summary>
    /// Obtener estad�sticas de duraci�n de visitas
    ...
    public async Task<IActionResult> GetDurationStats()
    {
        ...
        catch (Exception ex)
        {
            ...
            return StatusCode(500, new { error = "Error al obtener estad�sticas de duraci�n" });
        }
    }
    ...
    /// <summary>
    /// Obtener promedio de visitas por d�a de la semana
    ...
    public async Task<IActionResult> GetWeekdayAverage([FromQuery] int weeks = 4)
    {
        ...
        catch (Exception ex)
        {
            ...
            return StatusCode(500, new { error = "Error al obtener promedio por d�a de la semana" });
        }
    }
    ...
    /// <summary>
    /// Helper: Obtener etiqueta del d�a en espa�ol
    /// </summary>
