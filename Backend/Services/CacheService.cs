...
/// <summary>
/// Servicio de abstracci�n de cach�
/// Soporta Memory Cache (desarrollo) y Redis (producci�n)
...
public class CacheService
{
        ...
        IConfiguration configuration)
    {
        ...
        // Usar distributed cache solo si est� configurado (producci�n con Redis)
    ...
    /// <summary>
    /// Guardar valor en cach� con expiraci�n
    /// </summary>
    ...
    /// <summary>
    /// Obtener o crear valor en cach� (Remember pattern)
    /// </summary>
        ...
        TimeSpan? expiration = null)
    {
        ...
        catch (Exception ex)
        {
            ...
            // Si falla el cach�, al menos ejecutar la factory
            return await factory();
        }
    }

    /// <summary>
    /// Verificar si existe una key en cach�
    /// </summary>
    ...
    /// <summary>
    /// Limpiar m�ltiples keys por patr�n (solo para Memory Cache)
    /// NOTA: Redis requerir�a Lua script o KeyScan
    /// </summary>
    public void RemoveByPattern(string pattern)
    {
        try
        {
            ...
            // En producci�n con Redis, se usar�a SCAN + DEL
    ...
    /// <summary>
    /// Helper: Cache key para estad�sticas
    /// </summary>
    ...
    /// <summary>
    /// Helper: Invalidar cach� de visitas
    /// </summary>
